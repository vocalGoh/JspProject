...
<head>
<meta charset="UTF-8">
<title>BCrypt방식의 비밀번호 암호화 처리(회원가입시 처리됨)</title>
...
<script type="text/javascript">
	...
	function insert() {
		...
		$.ajax({
			type : "post",
			url : "/jsp02/member_servlet/join_bcrypt.do", //2. 결론적으로 이쪽에 도달하게 된다. 가상 URI가 들어왔으므로 MemberController.java로 가자. 암호화를 확인하기 위해 준혁이도 회원가입 시킨다 ㅎㅎ
			data : param,
			success : function() {
				list();//회원목록 갱신
				//입력값 초기화
